...
<body>
     <%
            if (request.getParameter("userreg1") != null) {%>
...
De duplication of Encrypted Data in Cloud</a></h4>
		</div>
		<div id="slogan">
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <!---star Body -->
          <form name="form1"  action="userregact.jsp" method="get">
 ...
 <tr>
                    <td>
                        ...
                        <td><select id="gen" name="gen" required style="height:34px; width:150px">
                    ...
                    <td>
                        ...
                        <td><select id="loc" name="location" required style="height:34px; width:150px">
                    ...
                    <tr>
                    <td>
                        <td><strong><font size="3" color="black">Job Position: </font></strong></td> 
                        <td><select id="job" name="jobposition" required style="height:34px; width:150px">
                               <option value="na" selected="" >Job Position:</option>
                                <option value="scientist" >Scientist</option>
                                        <option value="cardiologist">Cardiologist</option>
                                          <option value="LifeInstitute">Life Institute</option>  
                             <option value="GeneralHospital">General Hospital</option></select></td>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <td><select required style="height:34px; width:50px">
 ...
 <tr>
                    <td>
                        <td><strong><font size="3" color="black">Experience: </font></strong></td> 
                        <td><input type="text" name="exp" id="exp" placeholder= Experience required style="height:30px; width:200px"></input></td> 
                    </td>
                </tr>
